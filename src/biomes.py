from .base import Dimension, Version
from enum import Enum, IntEnum

class Biome(Enum): # biomes.BiomeID
	OCEAN = 0
	PLAINS = 1
	DESERT = 2
	...
	SHRUBLAND = 53
	THE_VOID = 127
	SUNFLOWER_PLAINS = 1 + 128 # PLAINS + 128
	DESERT_LAKES = 2 + 128 # DESERT + 128
	GRAVELLY_MOUNTAINS = WINDSWEPT_GRAVELLY_HILLS = 3 + 128 # MOUNTAINS + 128
	FLOWER_FOREST = 4 + 128 # FOREST + 128
	TAIGA_MOUNTAINS = 5 + 128 # TAIGA + 128
	SWAMP_HILLS = 6 + 128 # SWAMP + 128
	ICE_SPIKES = 12 + 128 # SNOWY_TUNDRA + 128
	MODIFIED_JUNGLE = 21 + 128 # JUNGLE + 128
	MODIFIED_JUNGLE_EDGE = 23 + 128 # JUNGLE_EDGE + 128
	TALL_BIRCH_FOREST = OLD_GROWTH_BIRCH_FOREST = 27 + 128 # BIRCH_FOREST + 128
	TALL_BIRCH_HILLS = 28 + 128 # BIRCH_FOREST_HILLS + 128
	DARK_FOREST_HILLS = 29 + 128 # DARK_FOREST + 128
	SNOWY_TAIGA_MOUNTAINS = 30 + 128 # SNOWY_TAIGA + 128
	GIANT_SPRUCE_TAIGA = OLD_GROWTH_SPRUCE_TAIGA = 32 + 128 # GIANT_TREE_TAIGA + 128
	GIANT_SPRUCE_TAIGA_HILLS = 33 + 128 # GIANT_TREE_TAIGA_HILLS + 128
	MODIFIED_GRAVELLY_MOUNTAINS = 34 + 128 # WOODED_MOUNTAINS + 128
	SHATTERED_SAVANNA = WINDSWEPT_SAVANNA = 35 + 128 # SAVANNA + 128
	SHATTERED_SAVANNA_PLATEAU = 36 + 128 # SAVANNA_PLATEAU + 128
	ERODED_BADLANDS = 37 + 128 # BADLANDS + 128
	MODIFIED_WOODED_BADLANDS_PLATEAU = 38 + 128 # WOODED_BADLANDS + 128
	MODIFIED_BADLANDS_PLATEAU = 39 + 128 # BADLANDS_PLATEAU + 128
	BAMBOO_JUNGLE = 168
